        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              whileHover={{ y: -10 }}
              className="bg-gradient-to-b from-gray-50 to-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-all border border-gray-100 relative overflow-hidden group"
            >
